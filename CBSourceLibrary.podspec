#
#  Be sure to run `pod spec lint CBSourceLibrary.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/Goooolden/CBSourceLibrary.git"
  ...
  s.source       = { :git => "https://github.com/Goooolden/CBSourceLibrary.git", :tag => "0.0.10" }
