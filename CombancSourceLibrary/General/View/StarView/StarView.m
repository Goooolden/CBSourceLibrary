...
#define STAR_FRONT_NAME @"pop-up_score_true" //点亮星星图片
#define STAR_BACK_NAME @"pop-up_score_false" // 未点亮星星图片
#define DEFALUT_STAR_NUMBER 5 // 默认星星个数
#define ANIMATION_TIME_INTERVAL 0.2 // 动画延时

@interface StarView ()

@property (nonatomic, strong) UIView *foregroundStarView; /**< 前景视图*/
@property (nonatomic, strong) UIView *backgroundStarView; /**< 背景视图*/
@property (nonatomic, assign) NSInteger numberOfStars; /**< 星星个数*/
@end
