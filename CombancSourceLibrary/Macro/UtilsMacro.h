...
#define KPOSTERIMGDATA @"KPosterImgData"
...
#define K_NAVIGATION_BAR_HEIGHT (CGRectGetHeight([[UIApplication sharedApplication] statusBarFrame]) + CGRectGetHeight(self.navigationController.navigationBar.frame))
#define K_STATUS_BAR_AND_NAVI_BAR_HEIGHT (K_STATUS_BAR_HEIGHT + 44.0f) // 20.0 + 44.0
